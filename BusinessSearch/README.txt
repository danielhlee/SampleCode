Created a business search program that is started from the command line with one argument, the filename of a textfile containing a list of businesses and phone numbers. Each line of the text file contains the business name, a comma, then a 
